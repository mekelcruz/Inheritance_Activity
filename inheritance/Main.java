public class Main {
    public static void main(String[] args) {
        ...
        Cylinder cylinder = new Cylinder("Pink", "Shiny", 7, 7);
        ...
        Rectangle rectangle = new Rectangle("Grey", "Matte", 20, 20);
        ...
        Box box = new Box("Green", "Glossy", 5, 5, 5);
        ...
        Triangle triangle = new Triangle("Blue", "Polished", 5, 5);
        ...
        Square square = new Square("Black", "Striped", 5);
        ...
        Cube cube = new Cube("Yellow", "Grainy", 5);
